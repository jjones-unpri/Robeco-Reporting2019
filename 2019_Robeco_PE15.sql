...
***Comment5=NIL(/*Final calculation of total indicator score: Calculate if there is more than one stage involved, then whether permutations derive greater than 2, then if the 3 ESG issues are at least 1 each, then score it as 3, or else score it accordingly*/)

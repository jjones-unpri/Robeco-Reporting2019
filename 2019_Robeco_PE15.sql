...
***Comment0=NIL(/*The stages of investment processes are provided to ensure ESG issues covers at least two different stages*/)
...
***PE_c_b_DD_Sum=IFBLANK(IF((PE_c_c_DD_score>0),100,0),0)
...
***Comment1=NIL(/*The following tracks the 5 different stages, summing all the same types each; an alternative score of max value 1 is dedicated to each 'Sum' result; a total score of different events is used, which will be marked against a threshold of being more than one for final calculation*/)
...
***Comment2=NIL(/*The following tracks the E, S, and G issues, counting only the score of each issue where there is a stage ticked/checked/marked, it will be scored at 100 each*/)

***PE_15_a_a_Env=SCORE("Robeco PE Survey 2019: (PE_15_a_a_Env) [Choice]Env", "a109edd2ab5843b2acc25c80562192e1", SURVEY_ID)
***PE_15_a_a_Env_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_a_a_Env>0),100,0)0))

***PE_15_a_b_Soc=SCORE("Robeco PE Survey 2019: (PE_15_a_b_Soc) [Choice]Soc", "45fae227cdf34f4a990c8bbf1b024da3", SURVEY_ID)
***PE_15_a_b_Soc_Sum=IF((((PE_b_a_IS_Sum)=0)OR((PE_b_b_DD_Sum)=0)OR((PE_b_c_ID_Sum)=0)OR((PE_b_d_IM_Sum)=0)OR((PE_b_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_a_b_Soc>0),100,0)0))

***PE_15_a_c_Gov=SCORE("Robeco PE Survey 2019: (PE_15_a_c_Gov) [Choice]Gov", "d200ea6ecf164e768e2059b532e4fa1f", SURVEY_ID)
***PE_15_a_c_Gov_Sum=IF((((PE_c_a_IS_Sum)=0)OR((PE_c_b_DD_Sum)=0)OR((PE_c_c_ID_Sum)=0)OR((PE_c_d_IM_Sum)=0)OR((PE_c_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_a_c_Gov>0),100,0)0))

***PE_15_b_a_Env=SCORE("Robeco PE Survey 2019: (PE_15_b_a_Env) [Choice]Env", "a109edd2ab5843b2acc25c80562192e1_1", SURVEY_ID)
***PE_15_b_a_Env_Sum=IF((((PE_d_a_IS_Sum)=0)OR((PE_d_b_DD_Sum)=0)OR((PE_d_c_ID_Sum)=0)OR((PE_d_d_IM_Sum)=0)OR((PE_d_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_b_a_Env>0),100,0)0))

***PE_15_b_b_Soc=SCORE("Robeco PE Survey 2019: (PE_15_b_b_Soc) [Choice]Soc", "45fae227cdf34f4a990c8bbf1b024da3_1", SURVEY_ID)
***PE_15_b_b_Soc_Sum=IF((((PE_e_a_IS_Sum)=0)OR((PE_e_b_DD_Sum)=0)OR((PE_e_c_ID_Sum)=0)OR((PE_e_d_IM_Sum)=0)OR((PE_e_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_b_b_Soc>0),100,0)0))

***PE_15_b_c_Gov=SCORE("Robeco PE Survey 2019: (PE_15_b_c_Gov) [Choice]Gov", "d200ea6ecf164e768e2059b532e4fa1f_1", SURVEY_ID)
***PE_15_b_c_Gov_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_b_c_Gov>0),100,0)0))

***PE_15_c_a_Env=SCORE("Robeco PE Survey 2019: (PE_15_c_a_Env) [Choice]Env", "a109edd2ab5843b2acc25c80562192e1_2", SURVEY_ID)
***PE_15_c_a_Env_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_c_a_Env>0),100,0)0))

***PE_15_c_b_Soc=SCORE("Robeco PE Survey 2019: (PE_15_c_b_Soc) [Choice]Soc", "45fae227cdf34f4a990c8bbf1b024da3_2", SURVEY_ID)
***PE_15_c_b_Soc_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_c_b_Soc>0),100,0)0))

***PE_15_c_c_Gov=SCORE("Robeco PE Survey 2019: (PE_15_c_c_Gov) [Choice]Gov", "d200ea6ecf164e768e2059b532e4fa1f_2", SURVEY_ID)
***PE_15_c_c_Gov_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_c_c_Gov>0),100,0)0))

***PE_15_d_a_Env=SCORE("Robeco PE Survey 2019: (PE_15_d_a_Env) [Choice]Env", "a109edd2ab5843b2acc25c80562192e1_3", SURVEY_ID)
***PE_15_d_a_Env_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_d_a_Env>0),100,0)0))

***PE_15_d_b_Soc=SCORE("Robeco PE Survey 2019: (PE_15_d_b_Soc) [Choice]Soc", "45fae227cdf34f4a990c8bbf1b024da3_3", SURVEY_ID)
***PE_15_d_b_Soc_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_d_b_Soc>0),100,0)0))

***PE_15_d_c_Gov=SCORE("Robeco PE Survey 2019: (PE_15_d_c_Gov) [Choice]Gov", "d200ea6ecf164e768e2059b532e4fa1f_3", SURVEY_ID)
***PE_15_d_c_Gov_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_d_c_Gov>0),100,0)0))

***PE_15_e_a_Env=SCORE("Robeco PE Survey 2019: (PE_15_e_a_Env) [Choice]Env", "a109edd2ab5843b2acc25c80562192e1_4", SURVEY_ID)
***PE_15_e_a_Env_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_e_a_Env>0),100,0)0))

***PE_15_e_b_Soc=SCORE("Robeco PE Survey 2019: (PE_15_e_b_Soc) [Choice]Soc", "45fae227cdf34f4a990c8bbf1b024da3_4", SURVEY_ID)
***PE_15_e_b_Soc_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_e_b_Soc>0),100,0)0))

***PE_15_e_c_Gov=SCORE("Robeco PE Survey 2019: (PE_15_e_c_Gov) [Choice]Gov", "d200ea6ecf164e768e2059b532e4fa1f_4", SURVEY_ID)
***PE_15_e_c_Gov_Sum=IF((((PE_A_a_IS_Sum)=0)OR((PE_A_b_DD_Sum)=0)OR((PE_A_c_ID_Sum)=0)OR((PE_A_d_IM_Sum)=0)OR((PE_A_e_PTE_Sum)=0)),0,IFBLANK(IF((PE_15_e_c_Gov>0),100,0)0))

***Comment3=NIL(/*The following sums up all E, S or G values each, an alternative score of max value 1 is dedicated to each 'Sum' result. The final line contains a conditional calculation if the score does not contain two or more different stages nor does it utilise more than one example in answers*/)
...
***Comment4=NIL(/*The following sums up all examples 1,2,3,4,5 each, which will be measured against a basis of being more than zero for calculating permutations*/)
...
***Comment5=NIL(/*The permutations calculates the conditionals for two consecutive events in order to track for the min req to 'cover at least two different stages of investment process'*/)
...
***Comment6=NIL(/*Final calculation of total indicator score: Calculate if there is more than one stage involved, then whether permutations derive greater than 2, then if the 3 ESG issues are at least 1 each, then score it as 3, or else score it accordingly*/)

***PE_15_Score=IF((PE_15_Stages_Total)>1,IF(((PE_15_a_b_Comb>1)OR(PE_15_a_c_Comb>1)OR(PE_15_a_d_Comb>1)OR(PE_15_a_e_Comb>1)OR(PE_15_b_a_Comb>1)OR(PE_15_b_c_Comb>1)OR(PE_15_b_d_Comb>1)OR(PE_15_b_e_Comb>1)OR(PE_15_c_a_Comb>1)OR(PE_15_c_b_Comb>1)OR(PE_15_c_d_Comb>1)OR(PE_15_c_e_Comb>1)OR(PE_15_d_a_Comb>1)OR(PE_15_d_b_Comb>1)OR(PE_15_d_c_Comb>1)OR(PE_15_d_e_Comb>1)OR(PE_15_e_a_Comb>1)OR(PE_15_e_b_Comb>1)OR(PE_15_e_c_Comb>1)OR(PE_15_e_d_Comb>1)),IF(((PE_15_Env_All_OneScore)>0)AND((PE_15_Env_All_OneScore)>0)AND((PE_15_Env_All_OneScore)>0),3,VALUE(PE_15_ESG_Total_MoreThan2)),VALUE(PE_15_ESG_Total_MoreThan2)),VALUE(PE_15_ESG_Total_MoreThan2))
